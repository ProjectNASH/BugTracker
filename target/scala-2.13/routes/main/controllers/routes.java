...
public class routes {
  ...
  public static final controllers.ReverseresetPassword resetPassword = new controllers.ReverseresetPassword(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseresetPassword resetPassword = new controllers.javascript.ReverseresetPassword(RoutesPrefix.byNamePrefix());
